...
@section('page-subtitle', 'Pengajuan izin kerja')

@section('content')
<div class="card fade-in-up">
    <div class="card-header">
        <i class="fas fa-file-alt me-2"></i>Data Pengajuan Izin
    </div>
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="mb-1">Daftar Pengajuan Izin</h5>
                <p class="text-muted mb-0">Kelola pengajuan izin kerja Anda</p>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Pengajuan Izin</h5>
            ...
            <form id="leaveForm">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="reason" id="reason" class="form-control" rows="3" placeholder="Masukkan alasan izin..." required></textarea>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.edit-leave').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('modalTitle').textContent = 'Edit Pengajuan Izin';
        ...
        document.getElementById('addModal').addEventListener('hidden.bs.modal', function () {
            ...
            document.getElementById('modalTitle').textContent = 'Pengajuan Izin';
