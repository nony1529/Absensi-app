...
@section('page-title', 'Sakit')
@section('page-subtitle', 'Pengajuan sakit')

@section('content')
<div class="card fade-in-up">
    <div class="card-header">
        <i class="fas fa-heartbeat me-2"></i>Data Pengajuan Sakit
    </div>
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="mb-1">Daftar Pengajuan Sakit</h5>
                <p class="text-muted mb-0">Kelola pengajuan sakit Anda</p>
            </div>
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">
                <i class="fas fa-plus me-2"></i>Ajukan Sakit
            </button>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Pengajuan Sakit</h5>
            ...
            <form id="leaveForm">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="reason" id="reason" class="form-control" rows="3" placeholder="Masukkan alasan sakit..." required></textarea>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.edit-leave').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('modalTitle').textContent = 'Edit Pengajuan Sakit';
        ...
        document.getElementById('addModal').addEventListener('hidden.bs.modal', function () {
            ...
            document.getElementById('modalTitle').textContent = 'Pengajuan Sakit';
